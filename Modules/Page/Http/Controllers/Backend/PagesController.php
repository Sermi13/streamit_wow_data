    ...
    public function show($slug, Request $request)
{
    ...
    try {
        ...
        $translator->setTarget($currentLang);
        $page->description = $translator->translate($page->description);
        $page->name        = $translator->translate($page->name);
    } catch (TranslationRequestException $e) {
        // Se der erro, mantém o texto original
        \Log::warning("Falha na tradução da página {$page->id}: ".$e->getMessage());
    }
