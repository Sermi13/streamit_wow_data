...
<div id="thumbnail-section">
    @include('frontend::components.section.thumbnail',  ['data' => $data['trailer_url'] ,'type'=>$data['trailer_url_type'],'thumbnail_image'=>$data['thumbnail_image'],'subtitle_info' => ''])
</div>
...
@include('frontend::components.chat-widget', ['contentId' => $data['id'] ?? '0', 'contentType' => 'tvshow'])
