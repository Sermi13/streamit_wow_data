...
@include('frontend::components.section.thumbnail',  ['data' => $data['video_url_input'] ,'type'=>$data['video_upload_type'],'thumbnail_image'=>$data['thumbnail_image'],'watched_time'=>$data['watched_time'], 'subtitle_info' => $data['subtitle_info']])
@else
@include('frontend::components.section.thumbnail',  ['data' => $data['trailer_url'] ,'type'=>$data['trailer_url_type'],'thumbnail_image'=>$data['thumbnail_image'],'watched_time'=>0,'subtitle_info' => $data['subtitle_info'],'dataAccess' => $data['movie_access'] , 'contentType' => $data['type'], 'contentId' => $data['id']])
...
@include('frontend::components.chat-widget', ['contentId' => $data['id'] ?? '0', 'contentType' => 'movie'])
