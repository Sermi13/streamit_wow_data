...
<div id="thumbnail-section">
    ...
    @endphp
    @include('frontend::components.section.thumbnail',  ['data' => $videodata ,'embedded' => $data['embedded'],'type'=>$data['stream_type'],'thumbnail_image'=>$data['poster_image'],'dataAccess'=>$data['access'],'plan_id'=>$data['plan_id'],'content_type' => 'livetv'])
</div>
