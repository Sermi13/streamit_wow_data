...
@if( $continue_watch===true)
        @include('frontend::components.section.thumbnail',  ['data' => $data['video_url_input'] ,'type'=>$data['video_upload_type'],'thumbnail_image'=>$data['poster_image'],'subtitle_info' => $data['subtitle_info'],'dataAccess' => $data['access'], 'continue_watch' => true,'watched_time'=>$data['watched_time']])
@else
    @include('frontend::components.section.thumbnail',  ['data' => $data['trailer_url'] ,'type'=>$data['trailer_url_type'],'thumbnail_image'=>$data['poster_image'],'subtitle_info' => $data['subtitle_info'],'dataAccess' => $data['access'], 'continue_watch' => false])
@endif
    </div>

<div id="detail-section">
    @include('frontend::components.section.episode_data',  ['data' => $data,'subtitle_info' => $data['subtitle_info']])
</div>
...
@include('frontend::components.chat-widget', ['contentId' => $data['id'] ?? '0', 'contentType' => 'episode'])
